...
<header id="masthead">
    ...
    <div class="elementor elementor-12" data-elementor-id="12" data-elementor-type="wp-post">
        <div class="elementor-element elementor-element-86e1d34 e-con-full e-flex e-con e-parent e-lazyloaded"
            ...
            <div class="elementor-element elementor-element-1c8e616 elementor-widget elementor-widget-html"
...
<nav aria-label="Primary" class="main-navigation nav-align-right has-menu-bar-items sub-menu-right"
    id="site-navigation">
    <div class="inside-navigation grid-container">
        <button aria-controls="primary-menu" aria-expanded="false" class="menu-toggle">
            <span class="gp-icon icon-menu-bars"><svg aria-hidden="true" height="1em" viewbox="0 0 512 512" width="1em"
                ...
                </svg><svg aria-hidden="true" height="1em" viewbox="0 0 512 512" width="1em"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div class="menu-bar-items"> <span class="menu-bar-item">
                <a aria-controls="gp-search" aria-haspopup="dialog" aria-label="Open search"
                    data-gpmodal-trigger="gp-search" href="#" role="button"><span class="gp-icon icon-search"><svg
                            aria-hidden="true" height="1em" viewbox="0 0 512 512" width="1em"
                            xmlns="http://www.w3.org/2000/svg">
